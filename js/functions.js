...
function calculateTip(percent, total) {
    var finalAmount = percent * total;
    return "You should tip $" + finalAmount.toFixed(2);
}
/**
 * TODO:
...
var convertToDecimal = (tipPercent * 0.010);
tipPercent = convertToDecimal;
...
function applyDiscount(price, percent) {
    var totalDue = (price - (price * percent));
    return "the amount due after discount is applied is $" + totalDue.toFixed(2);
}
